...
4. In the Asset Browser, select and load `Assets -> Scenes -> 01_CesiumUnity`. You can also select other scenes as you browse and explore the samples.
...
The sample scenes begin with a scene in San Francisco. You'll see [Cesium World Terrain](https://cesium.com/platform/cesium-ion/content/cesium-world-terrain/) and [Cesium OSM Buildings](https://cesium.com/platform/cesium-ion/content/cesium-osm-buildings/) in this scene. This scene is designed to familiarize you with the core Cesium game objects and components, like Cesium World Terrain and Cesium Georeference.
...
*<p align="center">Metadata of New York City buildings visualized.<br>Open <b>04_CesiumMetadata</b> in the Cesium for Unity Samples to explore the New York City's metadata.</p>*
